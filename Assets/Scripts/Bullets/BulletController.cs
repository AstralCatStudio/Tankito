...
namespace Tankito {
    ...
    public class BulletController : MonoBehaviour
    {
        ...
        void MoveBullet(float deltaTime)
        {
            ...
            m_rb.velocity += (BulletCannonRegistry.Instance[m_simObj.OwnerId].Properties.acceleration != 0f) ? BulletCannonRegistry.Instance[m_simObj.OwnerId].Properties.acceleration * 15 * m_rb.velocity.normalized : Vector2.zero;
